...
sync_frontend_env() {
  # Next only exposes NEXT_PUBLIC_* values to the browser bundle.
...
NEXT_PUBLIC_BUTTERBASE_APP_ID=${BUTTERBASE_APP_ID:-app_gsuwgmmbc74g}
NEXT_PUBLIC_BUTTERBASE_API_URL=${BUTTERBASE_API_URL:-https://api.butterbase.ai}
NEXT_PUBLIC_AUTO_LOGIN=1
NEXT_PUBLIC_DEMO_EMAIL=${SERVICE_EMAIL:-oncall@rescueops.dev}
NEXT_PUBLIC_DEMO_PASSWORD=${SERVICE_PASSWORD:-Resc!ue0ps2026}
EOF
}
